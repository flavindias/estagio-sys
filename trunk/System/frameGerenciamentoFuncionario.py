#Boa:Frame:frameGerenciamentoFuncionario

import wx
import bridge

def create(parent):
    return frameGerenciamentoFuncionario(parent)

[wxID_FRAMEGERENCIAMENTOFUNCIONARIO, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIOBOTAOADICIONAR, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIOBOTAOEDITAR, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIOBOTAOEXCLUIR, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIOBOTAOVOLTA, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIOBUTAOPESQUISAR, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIOLINHATELAINICIOSUPERIOR, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIOLOGOCANTOIFPE, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIOLOGOIFPE, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIONOMECADASTRAR, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIONOMEEDITAR, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIONOMEEXCLUIR, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIONOMEPESQUISAR, 
 wxID_FRAMEGERENCIAMENTOFUNCIONARIOPAINELHOME, 
] = [wx.NewId() for _init_ctrls in range(14)]

class frameGerenciamentoFuncionario(wx.Frame):
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Frame.__init__(self, id=wxID_FRAMEGERENCIAMENTOFUNCIONARIO,
              name=u'frameGerenciamentoFuncionario', parent=prnt,
              pos=wx.Point(700, 273), size=wx.Size(1040, 614),
              style=wx.DEFAULT_FRAME_STYLE,
              title=u'Est\xe1gio Curricular - Gerenciamento de Funcion\xe1rios')
        ...
        self.painelHome = wx.Panel(id=wxID_FRAMEGERENCIAMENTOFUNCIONARIOPAINELHOME,
        ...
        self.logoIFPE = wx.StaticBitmap(bitmap=wx.Bitmap(u'./Graficos/logo.png',
              wx.BITMAP_TYPE_PNG),
              id=wxID_FRAMEGERENCIAMENTOFUNCIONARIOLOGOIFPE, name=u'logoIFPE',
              parent=self.painelHome, pos=wx.Point(8, 8), size=wx.Size(175, 70),
              style=0)

        self.logoCantoIFPE = wx.StaticBitmap(bitmap=wx.Bitmap(u'./Graficos/logoBG.png',
              wx.BITMAP_TYPE_PNG),
              id=wxID_FRAMEGERENCIAMENTOFUNCIONARIOLOGOCANTOIFPE,
              name=u'logoCantoIFPE', parent=self.painelHome, pos=wx.Point(856,
              352), size=wx.Size(168, 227), style=0)

        self.linhaTelaInicioSuperior = wx.StaticBitmap(bitmap=wx.Bitmap(u'./Graficos/LinhaGerenciamentoFuncionarios.png',
              wx.BITMAP_TYPE_PNG),
              id=wxID_FRAMEGERENCIAMENTOFUNCIONARIOLINHATELAINICIOSUPERIOR,
              name=u'linhaTelaInicioSuperior', parent=self.painelHome,
              pos=wx.Point(0, 80), size=wx.Size(1024, 21), style=0)

        self.botaoAdicionar = wx.BitmapButton(bitmap=wx.Bitmap(u'./Graficos/botao_form_add.png',
              wx.BITMAP_TYPE_PNG),
              id=wxID_FRAMEGERENCIAMENTOFUNCIONARIOBOTAOADICIONAR,
        ...
        self.botaoEditar = wx.BitmapButton(bitmap=wx.Bitmap(u'./Graficos/botao_form_edt.png',
              wx.BITMAP_TYPE_PNG),
              id=wxID_FRAMEGERENCIAMENTOFUNCIONARIOBOTAOEDITAR,
        ...
        self.botaoExcluir = wx.BitmapButton(bitmap=wx.Bitmap(u'./Graficos/botao_form_del.png',
              wx.BITMAP_TYPE_PNG),
              id=wxID_FRAMEGERENCIAMENTOFUNCIONARIOBOTAOEXCLUIR,
        ...
        self.butaoPesquisar = wx.BitmapButton(bitmap=wx.Bitmap(u'./Graficos/botao_form_sch.png',
              wx.BITMAP_TYPE_PNG),
              id=wxID_FRAMEGERENCIAMENTOFUNCIONARIOBUTAOPESQUISAR,
        ...
        self.nomeCadastrar = wx.StaticText(id=wxID_FRAMEGERENCIAMENTOFUNCIONARIONOMECADASTRAR,
        ...
        self.nomeEditar = wx.StaticText(id=wxID_FRAMEGERENCIAMENTOFUNCIONARIONOMEEDITAR,
        ...
        self.nomeExcluir = wx.StaticText(id=wxID_FRAMEGERENCIAMENTOFUNCIONARIONOMEEXCLUIR,
        ...
        self.nomePesquisar = wx.StaticText(id=wxID_FRAMEGERENCIAMENTOFUNCIONARIONOMEPESQUISAR,
        ...
        self.botaoVolta = wx.BitmapButton(bitmap=wx.Bitmap(u'./Graficos/botao_voltar.png',
              wx.BITMAP_TYPE_PNG),
              id=wxID_FRAMEGERENCIAMENTOFUNCIONARIOBOTAOVOLTA,
