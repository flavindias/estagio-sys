...
[wxID_FRAMECADASTRO, wxID_FRAMECADASTROABACONTATO, 
 ...
 wxID_FRAMECADASTROBOTAOVOLTAR, wxID_FRAMECADASTROBUSCARCPF, 
 wxID_FRAMECADASTROCAMPOANIVERSARIO, wxID_FRAMECADASTROCAMPOANOCONCLUSAO, 
 wxID_FRAMECADASTROCAMPOBAIRRO, wxID_FRAMECADASTROCAMPOCELULAR, 
 wxID_FRAMECADASTROCAMPOCEP, wxID_FRAMECADASTROCAMPOCIDADE, 
 wxID_FRAMECADASTROCAMPOCOMPLEMENTO, wxID_FRAMECADASTROCAMPOCPF, 
 wxID_FRAMECADASTROCAMPOEMAIL, wxID_FRAMECADASTROCAMPOENDERECO, 
 wxID_FRAMECADASTROCAMPOMATRICULA, wxID_FRAMECADASTROCAMPONOMEALUNO, 
 wxID_FRAMECADASTROCAMPONOMEMAE, wxID_FRAMECADASTROCAMPONOMEPAI, 
 wxID_FRAMECADASTROCAMPONUMERO, wxID_FRAMECADASTROCAMPOTELEFONE, 
 wxID_FRAMECADASTROCAMPOUF, wxID_FRAMECADASTROCOMBOBOXCURSOS, 
 wxID_FRAMECADASTROCOMBOBOXDEPARTAMENTO, wxID_FRAMECADASTROCPFENCONTRADO, 
 wxID_FRAMECADASTROCPFNAOENCONTRADO, wxID_FRAMECADASTRODADOSDOSALUNOS, 
 wxID_FRAMECADASTRODATANASCIMENTO, wxID_FRAMECADASTROLINHAEDICAOALUNOS, 
 wxID_FRAMECADASTROLOGOIFPE, wxID_FRAMECADASTRONOMEANOCONCLUSAO, 
 wxID_FRAMECADASTRONOMEBAIRRO, wxID_FRAMECADASTRONOMECELULAR, 
 wxID_FRAMECADASTRONOMECEP, wxID_FRAMECADASTRONOMECIDADE, 
 wxID_FRAMECADASTRONOMECOMPLEMENTO, wxID_FRAMECADASTRONOMECPF, 
 wxID_FRAMECADASTRONOMECURSO, wxID_FRAMECADASTRONOMEDEPARTAMENTO, 
 wxID_FRAMECADASTRONOMEDISPONIBILIDADE, wxID_FRAMECADASTRONOMEEMAIL, 
 wxID_FRAMECADASTRONOMEENDERECO, wxID_FRAMECADASTRONOMEERRO, 
 wxID_FRAMECADASTRONOMEMATRICULA, wxID_FRAMECADASTRONOMENOMEALUNO, 
 wxID_FRAMECADASTRONOMENOMEMAE, wxID_FRAMECADASTRONOMENOMEPAI, 
 wxID_FRAMECADASTRONOMENUMERO, wxID_FRAMECADASTRONOMETELEFONE, 
 wxID_FRAMECADASTRONOMEUF, wxID_FRAMECADASTROOPCAOMANHA, 
 wxID_FRAMECADASTROOPCAONOITE, wxID_FRAMECADASTROOPCAOTARDE, 
 wxID_FRAMECADASTROPAINELCADASTRO, wxID_FRAMECADASTROSELECIONASEXO, 
...
class frameCadastro(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.linhaEdicaoAlunos = wx.StaticBitmap(bitmap=wx.Bitmap(u'./Graficos/LinhaEdicaoAlunos.png',
              wx.BITMAP_TYPE_PNG), id=wxID_FRAMECADASTROLINHAEDICAOALUNOS,
              name=u'linhaEdicaoAlunos', parent=self.painelCadastro,
        ...
        self.cpfNaoEncontrado = wx.StaticBitmap(bitmap=wx.Bitmap(u'./Graficos/botao_invalido.png',
              wx.BITMAP_TYPE_PNG), id=wxID_FRAMECADASTROCPFNAOENCONTRADO,
        ...
        self.cpfEncontrado = wx.StaticBitmap(bitmap=wx.Bitmap(u'./Graficos/botao_valido.png',
              wx.BITMAP_TYPE_PNG), id=wxID_FRAMECADASTROCPFENCONTRADO,
        ...
        self.BuscarCPF = wx.BitmapButton(bitmap=wx.Bitmap(u'./Graficos/botao_carregar.png',
              wx.BITMAP_TYPE_PNG), id=wxID_FRAMECADASTROBUSCARCPF,
        ...
        self.BuscarCPF.Bind(wx.EVT_BUTTON, self.OnBuscarCPFButton,
              id=wxID_FRAMECADASTROBUSCARCPF)
        ...
        self.nomeErro = wx.StaticText(id=wxID_FRAMECADASTRONOMEERRO, label=u'',
              name=u'nomeErro', parent=self.abaPessoal, pos=wx.Point(456, 40),
